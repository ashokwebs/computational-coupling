...
%
%  THE PAPER.  Supersedes and absorbs both earlier manuscripts, which were merged
%  into this file on 2026-08-25 and then deleted from the tree:
%    - paper/   "A Theory of Computational Coupling Between Intelligent Systems" v0.3.0
%    - paper2/  "Understanding Is Not Observable" v0.1.0
%  Both are recoverable from git history (see commit 94eca22 and its parents).
%  This is the single authoritative manuscript.
%
