...
emergent communication; hyperscanning; mechanistic interpretability; brain-to-brain
interfaces; instrumental variables.
...
\subsection{Roadmap}
\Cref{sec:setup} fixes notation and the causal object of interest. \Cref{sec:nonid} proves
non-identifiability. \Cref{sec:identification} characterises when identification is
...
Consider a dyad consisting of a sender $A$ and a receiver $B$ exchanging signals over some
channel.
...
directed information \citep{permuter2009directed}; phase-locking and coherence measures in
hyperscanning \citep{montague2002hyperscanning, hasson2010brain}; representational
...
\code{experiments/paper1\_rl/}. Numerical results are logged as JSON under \code{experiments/results/logs/}. The
