...
- [ ] Confirm the saturation law emerges under an *optimized* interface once training actually converges — 5-seed run at 1500 episodes/bandwidth with the fix in progress.
